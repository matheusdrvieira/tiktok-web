    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-2xl card-blur">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p>
            A sua privacidade é importante para nós. É política do Quizzio respeitar a sua
            privacidade em relação a qualquer informação sua que possamos coletar no site
            Quizzio, e outros sites que possuímos e operamos.
          </p>
          <p>
          ...
          <p><strong className="text-foreground">Compromisso do Usuário</strong></p>
          <p>
            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o
            Quizzio oferece no site e com caráter enunciativo, mas não limitativo:
          </p>
          <p>
            A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé e à ordem
            pública;
          </p>
          <p>
          ...
          <p>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Quizzio,
          ...
          <p>
            Mais informações: esperemos que esteja esclarecido e, como mencionado anteriormente, se
            houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar
            os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.
          </p>
          <p>Esta política é efetiva a partir de 19 February 2026 20:01.</p>
        </CardContent>
      </Card>
    </div>
  );
